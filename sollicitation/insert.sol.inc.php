...
include_once('uploadletter.inc.php');
  ...
  $sql = "INSERT INTO tb_sollicitation_responses_test (for_name, last_name, birthdate, city, street, house_number, postcode, e_mail, phone_number, CV, Motivation_letter, vac_id) 
