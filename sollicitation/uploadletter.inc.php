...
if (isset($name2)) {
    $path= '../db_docs/Motivationletter/'; //the path given is where the images will be uploaded into that location
    if (empty($name2))
       ...
       { if (move_uploaded_file($tmp_name, $path.$name2)) {echo 'Uploaded!'. $name2; }}}} //it uploads the image and gives a message confirming it did
?>
