    ...
    <div class="pagecon">
        ...
        <div class="mainbody"> 
           <section class="thankcon">
               <strong class='thanks'>bedankt <?php include_once('../connection.php');
               $sql = "SELECT for_name FROM tb_application_responses WHERE id=(SELECT max(id) FROM tb_application_responses)";
               ...
               echo $name;
               ?>, voor het solliciteren op onze website!</strong>
           </section>
        </div>
