...
<body>
    <div class="pagecon">
        ...
        <div class="mainbody">
            ...
            $sql = "SELECT * FROM tb_vacature_en WHERE id =" . $_GET['id'];
...
foreach($results as $key => $row) {
  $vacatureinfo .= "<div><h1>" . $row['vacature_type'] . "</h1></div> " . 
                   ...
                   "<div> <h3>requirements:</h3>" . $row['job_requirements'] . "</div><br />" .
                   "<div> <h3>recommended experience:</h3>" . $row['job_experience'] . "</div><br />" .
                   "<div> <h3>location:</h3>" . $row['job_location'] . "</div><br />" .
                   "<div> <h3>hours en salary:</h3>" . $row['job_workhours'] . "&nbsp; &nbsp; &nbsp;"
                           . $row['job_salary'] . "each week</div><br />" .
                   "<div> <h3>contact data:</h3>" . $row['contact_info_name'] . "</div>" .
                   "<div>" . $row['contact_info_phone'] . "</div>" .
                   "<div> close date: " . $row['job_closedate'] . "</div>" .
                   "<div>the vacancy " . $row['job_status'] . "</div>"
                   ;
}
$vac_id = $row['id'];
$vacatureinfo .= "</div>";
