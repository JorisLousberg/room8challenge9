<?php 
    function getDbConnection() {
        ...
        $sql = "INSERT INTO `tb_vacature_en` ( `vacature_type`, `function_tasks`, `contact_info_name`, `contact_info_phone`, `job_requirements`, 
        ...
        header("Location: vacaturetemplate_en.php?opslaan=success");
